...
FILES=(*CORE_FILES,'spotify.py','alerts.py','listener.py','screen.py','grouped.py','sendspin_player.py','bluetooth_receiver.py','bluetooth_backend.py','bluetooth_session.py')
