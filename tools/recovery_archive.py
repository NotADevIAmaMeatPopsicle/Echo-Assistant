...
FILES=(*LEGACY_FILES,'echo-announcements.json','echo-calendar-receipts.json','echo-doorbells.json','echo-group-music.json','echo-round-profile.json','echo-members.json','echo-calling.json','echo-google-calendar.json','echo-member-google.json','echo-video.json')
LIMITS={'echo-displays.json':1_000_000,'echo-schedules.json':1_500_000,'echo-household.json':800_000,
        'echo-announcements.json':2_000_000,'echo-calendar-receipts.json':4_000_000,'echo-members.json':6_000_000,'echo-member-google.json':8_000_000}
MAX_ENVELOPE=40_000_000
MAX_PHOTO=6_000_000
