...
(async()=>{
  ...
  try{
    ...
    await page.waitForFunction(()=>fresh('timers')&&document.getElementById('connection').hidden);
    ...
    assert.equal(await page.locator('#music-output-name').textContent(),'Echo round speaker');
