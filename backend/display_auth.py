...
def allowed(method,path):
    reads={'/v1/voice','/v1/home','/v1/display/home','/v1/state','/v1/household','/v1/schedules',
           ...
           '/v1/display/sources','/v1/display/agenda','/v1/display/photos','/v1/display/media','/v1/display/voice','/v1/display/briefing'}
    ...
    exact={
        'POST':{'/v1/chat','/v1/timers','/v1/household','/v1/schedules','/v1/memory','/v1/tasks','/v1/notifications','/v1/display/voice',
                '/v1/display/home/control','/v1/music/control','/v1/home/speakers/select','/v1/home/speakers/control','/v1/display/calendar/events'},
