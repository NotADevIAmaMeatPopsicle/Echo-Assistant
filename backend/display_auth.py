...
def allowed(method,path):
    ...
    reads={'/v1/voice','/v1/home','/v1/display/home','/v1/state','/v1/household','/v1/schedules',
           '/v1/routines','/v1/memory','/v1/tasks','/v1/chat/activity','/v1/display/session','/v1/music/groups','/v1/music/groups/stream',
    ...
    exact={
        'POST':{'/v1/chat','/v1/timers','/v1/household','/v1/schedules','/v1/memory','/v1/tasks','/v1/notifications','/v1/display/voice',
                '/v1/display/home/control','/v1/music/groups/control','/v1/music/groups/members','/v1/music/groups/library','/v1/music/groups/library/play','/v1/music/control','/v1/home/speakers/select','/v1/home/speakers/control','/v1/display/calendar/events','/v1/display/calendar/change','/v1/display/calendar/draft'},
